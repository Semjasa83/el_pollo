...
const level1 = new Level(
    ...
    [
        ...
        new Coins('img/8.Coin/Moneda1.png', 500, 310),
        new Coins('img/8.Coin/Moneda1.png', 700, 80),
        new Coins('img/8.Coin/Moneda1.png', 700, 310),
        new Coins('img/8.Coin/Moneda1.png', 999, 310),
        new Coins('img/8.Coin/Moneda1.png', 999, 80),
        new Coins('img/8.Coin/Moneda1.png', 1200, 310),
        new Coins('img/8.Coin/Moneda1.png', 1200, 80),
        new Coins('img/8.Coin/Moneda1.png', 2100, 310),
